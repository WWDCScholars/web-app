...
.scholars-list
  ...
  .scholar-thumbnail-loading
    ...
    background-image: linear-gradient(to top, $background-gray, transparentizeColor('sch-gray3', 0.9)), linear-gradient(to right, $sch-gray3 0%, $background-gray 20%, $sch-gray3 40%, $sch-gray3 100%)
